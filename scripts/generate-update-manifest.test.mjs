...
test("builds a cross-platform static updater manifest", () => {
    ...
    artifacts: [
      {
        ...
        updaterName: "LXCode_0.1.1_x64-setup.exe",
        signature: "windows-signature",
      },
      {
        updaterPlatform: "darwin-aarch64",
        updaterName: "LXCode_0.1.1_aarch64.app.tar.gz",
        signature: "arm-signature",
      },
      {
        updaterPlatform: "darwin-x86_64",
        updaterName: "LXCode_0.1.1_x64.app.tar.gz",
  ...
  assert.deepEqual(manifest, {
    ...
    platforms: {
      "windows-x86_64": {
        signature: "windows-signature",
        url: "https://github.com/Laoxiao7274/LX-Code/releases/download/v0.1.1/LXCode_0.1.1_x64-setup.exe",
      },
      "darwin-aarch64": {
        signature: "arm-signature",
        url: "https://github.com/Laoxiao7274/LX-Code/releases/download/v0.1.1/LXCode_0.1.1_aarch64.app.tar.gz",
      },
      "darwin-x86_64": {
        signature: "intel-signature",
        url: "https://github.com/Laoxiao7274/LX-Code/releases/download/v0.1.1/LXCode_0.1.1_x64.app.tar.gz",
      },
    },
  });
});
...
test("normalizes macOS artifact names so architectures cannot collide", () => {
  assert.deepEqual(
    normalizedReleaseNames({
      ...
      platform: "darwin",
      arch: "arm64",
      primaryName: "LXCode.dmg",
    }),
    {
      primary: "LXCode_0.1.1_aarch64.dmg",
      updater: "LXCode_0.1.1_aarch64.app.tar.gz",
    },
  );
  assert.deepEqual(
    normalizedReleaseNames({
    ...
    {
      primary: "LXCode_0.1.1_x64.dmg",
      updater: "LXCode_0.1.1_x64.app.tar.gz",
    },
  );
});
    ...
    const fixtures = [
      {
        ...
        platform: "win32",
        arch: "x64",
        primaryName: "LXCode_0.1.1_x64-setup.exe",
        updaterName: "LXCode_0.1.1_x64-setup.exe",
      },
      {
        updaterPlatform: "darwin-aarch64",
        platform: "darwin",
        arch: "arm64",
        primaryName: "LXCode_0.1.1_aarch64.dmg",
        updaterName: "LXCode_0.1.1_aarch64.app.tar.gz",
      },
    ];

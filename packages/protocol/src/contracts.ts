...
export type HostContextMap = {
  ...
  "workspace.initialize": WorkspaceContext;
  ...
  "provider.probeModel": HostContext;
  ...
  "builtinExtensions.list": HostContext;
  "builtinExtensions.setEnabled": HostContext;
...
export type HostRequestParams = {
  ...
  "provider.probeModel": { providerId: string; modelId: string };
  ...
  "builtinExtensions.list": null;
  "builtinExtensions.setEnabled": { extensionId: string; enabled: boolean };
  "model.list": null;
...
export type HostResultMap = {
  ...
  "workspace.initialize": { git: boolean; codegraph: boolean; message: string };
  ...
  "provider.probeModel": ModelProbeResult;
  ...
  "builtinExtensions.list": { extensions: BuiltinExtensionInfo[] };
  "builtinExtensions.setEnabled": { extensionId: string; enabled: boolean };
  "model.list": {
    models: ModelSummary[];

...
const VALID_PARAMS: Record<HostMethod, unknown> = {
  ...
  "provider.probeModel": { providerId: "local", modelId: "model-1" },
  ...
  "builtinExtensions.setEnabled": { extensionId: "codegraph", enabled: false },
  "model.list": null,
...
function invalidParams(method: HostMethod): unknown {
  switch (method) {
    ...
    case "provider.probeModel":
      return { providerId: "local", modelId: "model-1", reasoning: true, vision: false, embeddings: false, contextWindow: null };
    case "provider.setBuiltinModels":
      return { providerId: "anthropic", modelIds: "all" };
    case "builtinExtensions.list":
      return { extensions: [{ id: "codegraph", name: "CodeGraph", enabled: true }] };
    case "builtinExtensions.setEnabled":
      return { extensionId: "codegraph", enabled: false };

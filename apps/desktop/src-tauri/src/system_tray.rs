...
const TRAY_ID: &str = "lxcode-tray";

#[cfg(any(target_os = "windows", test))]
const OPEN_MENU_ID: &str = "lxcode-tray-open";
#[cfg(any(target_os = "windows", test))]
const QUIT_MENU_ID: &str = "lxcode-tray-quit";
...
fn install_windows(app: &mut tauri::App) -> tauri::Result<()> {
    ...
    let menu = MenuBuilder::new(app)
        .text(OPEN_MENU_ID, "Open LXCode")
        .separator()
        .text(QUIT_MENU_ID, "Quit LXCode")
        .build()?;

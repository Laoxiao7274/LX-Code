...
type DockBrowserCloseHandler = () => void;
const closeHandlers = new Set<DockBrowserCloseHandler>();

/** Ask the right Dock to close the active browser tab and collapse the dock. */
export function requestDockBrowserClose(): boolean {
...
export function subscribeDockBrowserClose(handler: DockBrowserCloseHandler): () => void {
